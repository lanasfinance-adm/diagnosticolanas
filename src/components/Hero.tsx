    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-dark">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          {/* Main headline */}
          <motion.h1
            className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-secondary-foreground"
            initial={{
              opacity: 0,
              y: 20,
            }}
          ...
          >
            E se o seu patrimônio pudesse crescer mais rápido usando estratégias que você ainda não conhece? Descubra
            como organizar suas<span className="text-gradient-gold block mt-2">Finanças em 7 Dias</span>
          </motion.h1>
          ...
          >
            Em 45 minutos de reunião com um Nexialista Patrimonial, você sai com um diagnóstico financeiro
            personalizado, e com caminhos reais para acelerar sua construção de patrimônio.
          </motion.p>
